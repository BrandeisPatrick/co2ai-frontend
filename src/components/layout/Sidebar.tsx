    ...
    <aside className="w-64 glass-sidebar flex flex-col h-screen">
      ...
      <div className="p-4 border-b border-white/20 dark:border-gray-800/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold text-gray-900 md:text-gray-700 dark:text-white">Green Bio Compute</h1>
          </div>
        </div>
      </div>
                ...
                <Link
                  ...
                  className={`
                    ...
                    ${isActive
                      ...
                      : 'text-gray-900 md:text-gray-700 dark:text-white hover:bg-white/20 dark:hover:bg-gray-700/20 hover:text-gray-900 md:hover:text-gray-700 dark:hover:text-white'
                    }
                  `}
                >
                  {item.icon}
