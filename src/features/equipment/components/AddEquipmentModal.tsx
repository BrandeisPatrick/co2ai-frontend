...
export default function AddEquipmentModal({ isOpen, onClose, onSubmit }: AddEquipmentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden">
      ...
      {/* Modal */}
      <div className="glass-modal relative rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-hidden m-4 border border-white/20">
        {/* Header */}
        <div className="sticky top-0 glass-modal border-b border-white/20 px-6 py-4 flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-emerald-600 transition-colors"
                  placeholder="e.g., #001"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  } rounded-lg text-gray-900 focus:outline-none focus:border-emerald-600 transition-colors`}
                >
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 px-4 py-2.5 bg-white border ${
                      errors.dailyEmissionsValue ? 'border-red-500' : 'border-gray-300'
                    } rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-emerald-600 transition-colors`}
                    placeholder="0.0"
                  />
                  <select
                    ...
                    className="px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-600 transition-colors"
                  >
