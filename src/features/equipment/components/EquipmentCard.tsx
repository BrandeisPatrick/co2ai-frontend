    ...
    <div className="glass-card-hover rounded-xl overflow-hidden">
      ...
      <div className="p-4 border-b border-white/20 dark:border-gray-700/30">
        <div className="flex items-start justify-between mb-2">
          ...
          <button className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors flex-shrink-0 ml-2">
            <MoreVertical size={20} className="text-gray-600 dark:text-gray-400" />
          </button>
        </div>
        <div className="flex items-center gap-2 flex-wrap">
          <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs rounded-md border border-gray-300 dark:border-gray-600">
            {equipment.type}
          </span>
        </div>
      </div>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 h-48 flex items-center justify-center border-b border-gray-200 dark:border-gray-700">
