    ...
    <aside className="w-64 glass-sidebar flex flex-col h-screen">
      ...
      <div className="p-4 border-b border-white/20 dark:border-gray-700/30">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-400 dark:to-emerald-500 rounded-lg flex items-center justify-center">
          ...
          <div>
            <h1 className="text-sm font-semibold text-gray-900 md:text-gray-700 dark:text-gray-100">Green Bio Compute</h1>
          </div>
        </div>
      </div>
                ...
                <Link
                  ...
                  className={`
                    ...
                    ${isActive
                      ...
                      : 'text-gray-900 md:text-gray-700 dark:text-gray-100 hover:bg-white/20 dark:hover:bg-gray-800/40 hover:text-gray-900 md:hover:text-gray-700 dark:hover:text-gray-100'
                    }
                  `}
                >
                  {item.icon}
