...
const mockDashboardData: DashboardData = {
  ...
  monthlyTrend: [
    ...
    { month: 'Apr', emissions: 58 },
    { month: 'May', emissions: 62 },
    { month: 'Jun', emissions: 43 }
  ],
  topEquipment: [
    { name: 'ULT Freezer\n-80°C', emissions: 120, color: '#60A5FA' },
    { name: 'CO2 Incubator', emissions: 85, color: '#C084FC' },
    { name: 'Biosafety\nCabinet', emissions: 60, color: '#34D399' },
    { name: 'Autoclave', emissions: 45, color: '#FB923C' },
    { name: 'PCR Machine', emissions: 30, color: '#4ADE80' }
  ],
  alerts: [
    {
      id: '1',
    ...
    },
    {
      ...
      equipment: 'CO2 Incubators Lab B',
      equipmentId: '',
